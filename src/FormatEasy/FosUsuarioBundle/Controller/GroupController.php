...
class GroupController extends BaseController
{
    ...
    public function listAction()
    {
        ...
        return $this->container->get('templating')->renderResponse('FormatEasyFosUsuarioBundle:Group:list.html.'.$this->getEngine(), array('groups' => $groups));
    }
    ...
    public function showAction($groupName)
    {
        ...
        return $this->container->get('templating')->renderResponse('FormatEasyFosUsuarioBundle:Group:show.html.'.$this->getEngine(), array('group' => $group));
    }
    ...
    public function editAction(Request $request, $groupName)
    {
        ...
        return $this->container->get('templating')->renderResponse('FormatEasyFosUsuarioBundle:Group:edit.html.'.$this->getEngine(), array(
    ...
    public function newAction(Request $request)
    {
        ...
        return $this->container->get('templating')->renderResponse('FormatEasyFosUsuarioBundle:Group:new.html.'.$this->getEngine(), array(
            'form' => $form->createview(),
        ));
    }
